# proctition_platinum
# Write a method proctition_platinum that accepts an array and any
#  number of additional procs as 
# arguments. The method should return a hash where 
...
# the elements of the input array that return true when passed into the corresponding proc.
